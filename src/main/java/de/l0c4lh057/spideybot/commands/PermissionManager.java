package de.l0c4lh057.spideybot.commands;

import de.l0c4lh057.spideybot.utils.exceptions.BotException;
import de.l0c4lh057.spideybot.data.DataHandler;
import de.l0c4lh057.spideybot.data.DiscordCache;
...
public class PermissionManager {
	...
	@NonNull
	private static Mono<Void> checkExecutability(@NonNull Snowflake guildId, @NonNull Snowflake userId, @NonNull List<Snowflake> roleIds, @NonNull PermissionSet effectivePermissions, @Nullable de.l0c4lh057.spideybot.utils.Permission requiredPermissions){
	...
	public static Mono<Void> checkExecutability(@Nullable Snowflake guildId, @NonNull Snowflake userId,
	                                            @NonNull Snowflake channelId, @Nullable de.l0c4lh057.spideybot.utils.Permission permission,
	 ...
	 */
	public static Mono<Void> checkExecutability(@Nullable Snowflake guildId, @NonNull Snowflake userId,
	                                            @NonNull Snowflake channelId, @NonNull de.l0c4lh057.spideybot.utils.Permission permission,
	 ...
	 */
	public static Mono<Void> checkExecutability(@Nullable Snowflake guildId, @NonNull Snowflake userId,
	                                            @NonNull de.l0c4lh057.spideybot.utils.Permission permission, boolean requiresGuildOwner){
		if(guildId == null) return Mono.empty();
		return Mono.justOrEmpty(DiscordCache.getGuild(guildId).flatMap(guild -> guild.getMember(userId)))
				.switchIfEmpty(Mono.error(BotException.missingPermissions("exception.notcached")))
				.flatMap(member -> {
